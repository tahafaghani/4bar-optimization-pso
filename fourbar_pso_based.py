"""
This program is written by Taha Faghani
This code simply optimizes the 4 bar mechansim's parameters ,and then plot the path of the point P and show the optimum length and angle of the 4bar
"""
...
best_params, best_cost = pso(objective_function, [b[0] for b in bounds], [b[1] for b in bounds], swarmsize=300, maxiter=3000, minstep=1e-8, minfunc=1e-8)
#Now we print the best values for r1, r2, r3, r4, r5 , Theta1
print(f"Best parameters:  r1={best_params[0]:.3f} cm")
print(f"r2={best_params[1]:0.3f}, r3={best_params[2]:0.3f} cm")
print(f"r4={best_params[3]:0.3f}, r5={best_params[4]:0.3f} cm")
print(f"theta1={best_params[5]:0.3f} rad")
